...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //!
      NATIVE_INT_TYPE getNum_to_seqCmdBuff() const;

      //! Get the number of from_seqCmdStatus ports
      //!
      //! \return The number of from_seqCmdStatus ports
      //!
      NATIVE_INT_TYPE getNum_from_seqCmdStatus() const;
    ...
    protected:
      ...
      typedef struct {
        U32 Opcode;
        I32 port;
      } EventEntry_OpCodeReregistered;

      //! The history of OpCodeReregistered events
      //!
      History<EventEntry_OpCodeReregistered>
        *eventHistory_OpCodeReregistered;
