...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Connect seqCancelIn to to_seqCancelIn[portNum]
      //!
      void connect_to_seqCancelIn(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          Svc::InputCmdSeqCancelPort *const seqCancelIn /*!< The port*/
      );
    ...
    protected:
      ...
      //!
      virtual ~CmdSequencerTesterBase();
    ...
    protected:
      ...
      */
      ...
      //! Invoke the to port connected to seqCancelIn
      //!
      void invoke_to_seqCancelIn(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    public:
      ...
      //!
      NATIVE_INT_TYPE getNum_from_comCmdOut() const;
      ...
      //! Get the number of to_seqCancelIn ports
      //!
      //! \return The number of to_seqCancelIn ports
      //!
      NATIVE_INT_TYPE getNum_to_seqCancelIn() const;

      //! Get the number of from_seqDone ports
      //!
      //! \return The number of from_seqDone ports
      //!
      NATIVE_INT_TYPE getNum_from_seqDone() const;

      //! Get the number of to_seqRunIn ports
      //!
      //! \return The number of to_seqRunIn ports
      //!
      NATIVE_INT_TYPE getNum_to_seqRunIn() const;
    ...
    protected:
      ...
      //! Check whether port is connected
      //!
      //! Whether to_seqCancelIn[portNum] is connected
      //!
      bool isConnected_to_seqCancelIn(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Send a CS_JOIN_WAIT command
      //!
      void sendCmd_CS_JOIN_WAIT(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq /*!< The command sequence number*/
      );
    ...
    protected:
      ...
      //! Handle event CS_JoinWaiting
      //!
      virtual void logIn_ACTIVITY_HI_CS_JoinWaiting(
          const Fw::LogStringArg& filename, /*!< The sequence file*/
          U32 recordNumber, /*!< The record number*/
          U32 opCode /*!< The opcode*/
      );

      //! A history entry for event CS_JoinWaiting
      //!
      typedef struct {
        Fw::LogStringArg filename;
        U32 recordNumber;
        U32 opCode;
      } EventEntry_CS_JoinWaiting;

      //! The history of CS_JoinWaiting events
      //!
      History<EventEntry_CS_JoinWaiting>
        *eventHistory_CS_JoinWaiting;
    ...
    protected:
      ...
      //! Handle event CS_JoinWaitingNotComplete
      //!
      virtual void logIn_WARNING_HI_CS_JoinWaitingNotComplete(

      );

      //! Size of history for event CS_JoinWaitingNotComplete
      //!
      U32 eventsSize_CS_JoinWaitingNotComplete;
    ...
    private:
      ...
      //! To port connected to seqCancelIn
      //!
      Svc::OutputCmdSeqCancelPort m_to_seqCancelIn[1];
