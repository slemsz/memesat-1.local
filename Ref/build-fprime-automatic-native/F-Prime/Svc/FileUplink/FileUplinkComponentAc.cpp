...
#include "F-Prime/Svc/FileUplink/FileUplinkComponentAc.hpp"
...
namespace Svc {
  ...
  void FileUplinkComponentBase ::
    log_WARNING_HI_FileOpenError(const Fw::LogStringArg& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileUplinkComponentBase ::
    log_ACTIVITY_HI_FileReceived(const Fw::LogStringArg& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileUplinkComponentBase ::
    log_WARNING_HI_FileWriteError(const Fw::LogStringArg& fileName)
  {
  ...
  void FileUplinkComponentBase ::
    log_WARNING_HI_DecodeError(I32 status)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
