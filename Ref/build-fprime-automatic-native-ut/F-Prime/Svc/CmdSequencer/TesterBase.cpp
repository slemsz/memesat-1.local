...
namespace Svc {
      ...
      Fw::PassiveComponentBase(compName)
  {
    ...
    this->eventHistory_CS_JoinWaiting =
      new History<EventEntry_CS_JoinWaiting>(maxHistorySize);
    ...
    ~CmdSequencerTesterBase()
  {
    ...
    delete this->eventHistory_CS_JoinWaiting;
    // Destroy port histories
    delete this->fromPortHistory_comCmdOut;
    // Destroy port histories
    delete this->fromPortHistory_pingOut;
    // Destroy port histories
    delete this->fromPortHistory_seqDone;
  }
    ...
    )
  {
    ...
    for (
        PlatformIntType _port = 0;
        _port < static_cast<PlatformIntType>(this->getNum_from_comCmdOut());
        ++_port
    ) {
      ...
      (void) snprintf(
          _portName,
          sizeof(_portName),
          "%s_from_comCmdOut[%" PRI_PlatformIntType "]",
          this->m_objName,
          _port
      );
    ...
    for (
        PlatformIntType _port = 0;
        _port < static_cast<PlatformIntType>(this->getNum_from_seqDone());
        ++_port
    ) {
      ...
      (void) snprintf(
          _portName,
          sizeof(_portName),
          "%s_from_seqDone[%" PRI_PlatformIntType "]",
          this->m_objName,
          _port
      );
    ...
    // Initialize output port seqCancelIn

    for (
        PlatformIntType _port = 0;
        _port < static_cast<PlatformIntType>(this->getNum_to_seqCancelIn());
        ++_port
    ) {
      this->m_to_seqCancelIn[_port].init();
      ...
      snprintf(
          _portName,
          sizeof(_portName),
          "%s_to_seqCancelIn[%" PRI_PlatformIntType "]",
          this->m_objName,
          _port
      );
      this->m_to_seqCancelIn[_port].setObjName(_portName);
#endif
    ...
    for (
        PlatformIntType _port = 0;
        _port < static_cast<PlatformIntType>(this->getNum_to_seqRunIn());
        ++_port
    ) {
      ...
      snprintf(
          _portName,
          sizeof(_portName),
          "%s_to_seqRunIn[%" PRI_PlatformIntType "]",
          this->m_objName,
          _port
      );
  ...
  NATIVE_INT_TYPE CmdSequencerTesterBase ::
    getNum_from_comCmdOut() const
  {
    return static_cast<NATIVE_INT_TYPE>(FW_NUM_ARRAY_ELEMENTS(this->m_from_comCmdOut));
  }
  ...
  NATIVE_INT_TYPE CmdSequencerTesterBase ::
    getNum_to_seqCancelIn() const
  {
    return static_cast<NATIVE_INT_TYPE>(FW_NUM_ARRAY_ELEMENTS(this->m_to_seqCancelIn));
  }

  NATIVE_INT_TYPE CmdSequencerTesterBase ::
    getNum_from_seqDone() const
  {
    return static_cast<NATIVE_INT_TYPE>(FW_NUM_ARRAY_ELEMENTS(this->m_from_seqDone));
  }

  NATIVE_INT_TYPE CmdSequencerTesterBase ::
    getNum_to_seqRunIn() const
  {
    return static_cast<NATIVE_INT_TYPE>(FW_NUM_ARRAY_ELEMENTS(this->m_to_seqRunIn));
  }
  ...
  void CmdSequencerTesterBase ::
    connect_to_seqCancelIn(
        const NATIVE_INT_TYPE portNum,
        Svc::InputCmdSeqCancelPort *const seqCancelIn
    )
  {
    FW_ASSERT(portNum < this->getNum_to_seqCancelIn(),static_cast<FwAssertArgType>(portNum));
    this->m_to_seqCancelIn[portNum].addCallPort(seqCancelIn);
  }
  ...
  {
    FW_ASSERT(portNum < this->getNum_to_seqRunIn(),static_cast<FwAssertArgType>(portNum));
  ...
  void CmdSequencerTesterBase ::
    invoke_to_seqCancelIn(
        const NATIVE_INT_TYPE portNum
    )
  {
    FW_ASSERT(portNum < this->getNum_to_seqCancelIn(),static_cast<FwAssertArgType>(portNum));
    FW_ASSERT(portNum < this->getNum_to_seqCancelIn(),static_cast<FwAssertArgType>(portNum));
    this->m_to_seqCancelIn[portNum].invoke(
  ...
  bool CmdSequencerTesterBase ::
    isConnected_to_seqCancelIn(const NATIVE_INT_TYPE portNum)
  {
    FW_ASSERT(portNum < this->getNum_to_seqCancelIn(), static_cast<FwAssertArgType>(portNum));
    return this->m_to_seqCancelIn[portNum].isConnected();
  }
  ...
  {
    FW_ASSERT(portNum < this->getNum_from_comCmdOut(),static_cast<FwAssertArgType>(portNum));
  ...
  {
    FW_ASSERT(portNum < this->getNum_from_seqDone(),static_cast<FwAssertArgType>(portNum));
  ...
  // ----------------------------------------------------------------------
  // Command: CS_JOIN_WAIT
  // ----------------------------------------------------------------------

  void CmdSequencerTesterBase ::
    sendCmd_CS_JOIN_WAIT(
        const NATIVE_INT_TYPE instance,
        const U32 cmdSeq
    )
  {
    ...
    FwOpcodeType _opcode;
    const U32 idBase = this->getIdBase();
    _opcode = CmdSequencerComponentBase::OPCODE_CS_JOIN_WAIT + idBase;
    ...
    switch (id - idBase) {
      ...
      case CmdSequencerComponentBase::EVENTID_CS_FILEINVALID:
      {
...
#if FW_AMPCS_COMPATIBLE
        {
          ...
          FW_ASSERT(_argSize == sizeof(Svc::CmdSequencer_FileReadStage),_argSize,sizeof(Svc::CmdSequencer_FileReadStage));
        }
#endif
      ...
      case CmdSequencerComponentBase::EVENTID_CS_MODESWITCHED:
      {
...
#if FW_AMPCS_COMPATIBLE
        {
          ...
          FW_ASSERT(_argSize == sizeof(Svc::CmdSequencer_SeqMode),_argSize,sizeof(Svc::CmdSequencer_SeqMode));
        }
#endif
      ...
      case CmdSequencerComponentBase::EVENTID_CS_JOINWAITING:
      {
        ...
        this->logIn_ACTIVITY_HI_CS_JoinWaiting(filename, recordNumber, opCode);

        break;

      }

      case CmdSequencerComponentBase::EVENTID_CS_JOINWAITINGNOTCOMPLETE:
      {
...
#endif
        this->logIn_WARNING_HI_CS_JoinWaitingNotComplete();
    ...
    clearEvents()
  {
    ...
    this->eventHistory_CS_JoinWaiting->clear();
    this->eventsSize_CS_JoinWaitingNotComplete = 0;
  }
  ...
  void CmdSequencerTesterBase ::
    logIn_ACTIVITY_HI_CS_JoinWaiting(
        const Fw::LogStringArg& filename,
        U32 recordNumber,
        U32 opCode
    )
  {
    EventEntry_CS_JoinWaiting e = {
      filename, recordNumber, opCode
    };
    eventHistory_CS_JoinWaiting->push_back(e);
    ++this->eventsSize;
  }
  ...
  void CmdSequencerTesterBase ::
    logIn_WARNING_HI_CS_JoinWaitingNotComplete(

    )
  {
    ++this->eventsSize_CS_JoinWaitingNotComplete;
    ++this->eventsSize;
  }
