...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //!
      virtual ~ActiveLoggerTesterBase();
    ...
    public:
      ...
      //!
      NATIVE_INT_TYPE getNum_from_FatalAnnounce() const;
      ...
      //!
      NATIVE_INT_TYPE getNum_to_LogRecv() const;
    ...
    protected:
      ...
      //! Send a SET_EVENT_FILTER command
      //!
      void sendCmd_SET_EVENT_FILTER(
      ...
      //! Send a SET_ID_FILTER command
      //!
      void sendCmd_SET_ID_FILTER(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq, /*!< The command sequence number*/
          U32 ID, 
      ...
      //! Send a DUMP_FILTER_STATE command
      //!
      void sendCmd_DUMP_FILTER_STATE(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq /*!< The command sequence number*/
      );
    ...
    protected:
      ...
      //! Handle event SEVERITY_FILTER_STATE
      //!
      virtual void logIn_ACTIVITY_LO_SEVERITY_FILTER_STATE(
          Svc::ActiveLogger_FilterSeverity severity, /*!< The severity level*/
          bool enabled 
      );

      //! A history entry for event SEVERITY_FILTER_STATE
      //!
      typedef struct {
        Svc::ActiveLogger_FilterSeverity severity;
        bool enabled;
      } EventEntry_SEVERITY_FILTER_STATE;

      //! The history of SEVERITY_FILTER_STATE events
      //!
      History<EventEntry_SEVERITY_FILTER_STATE>
        *eventHistory_SEVERITY_FILTER_STATE;
    ...
    protected:
      ...
      //! Handle event ID_FILTER_ENABLED
      //!
      virtual void logIn_ACTIVITY_HI_ID_FILTER_ENABLED(
          U32 ID /*!< The ID filtered*/
      );

      //! A history entry for event ID_FILTER_ENABLED
      //!
      typedef struct {
        U32 ID;
      } EventEntry_ID_FILTER_ENABLED;

      //! The history of ID_FILTER_ENABLED events
      //!
      History<EventEntry_ID_FILTER_ENABLED>
        *eventHistory_ID_FILTER_ENABLED;
    ...
    protected:
      ...
      //! Handle event ID_FILTER_LIST_FULL
      //!
      virtual void logIn_WARNING_LO_ID_FILTER_LIST_FULL(
          U32 ID /*!< The ID filtered*/
      );

      //! A history entry for event ID_FILTER_LIST_FULL
      //!
      typedef struct {
        U32 ID;
      } EventEntry_ID_FILTER_LIST_FULL;

      //! The history of ID_FILTER_LIST_FULL events
      //!
      History<EventEntry_ID_FILTER_LIST_FULL>
        *eventHistory_ID_FILTER_LIST_FULL;
    ...
    protected:
      ...
      //! Handle event ID_FILTER_REMOVED
      //!
      virtual void logIn_ACTIVITY_HI_ID_FILTER_REMOVED(
          U32 ID /*!< The ID removed*/
      );

      //! A history entry for event ID_FILTER_REMOVED
      //!
      typedef struct {
        U32 ID;
      } EventEntry_ID_FILTER_REMOVED;

      //! The history of ID_FILTER_REMOVED events
      //!
      History<EventEntry_ID_FILTER_REMOVED>
        *eventHistory_ID_FILTER_REMOVED;
    ...
    protected:
      ...
      //! Handle event ID_FILTER_NOT_FOUND
      //!
      virtual void logIn_WARNING_LO_ID_FILTER_NOT_FOUND(
          U32 ID /*!< The ID removed*/
      );

      //! A history entry for event ID_FILTER_NOT_FOUND
      //!
      typedef struct {
        U32 ID;
      } EventEntry_ID_FILTER_NOT_FOUND;

      //! The history of ID_FILTER_NOT_FOUND events
      //!
      History<EventEntry_ID_FILTER_NOT_FOUND>
        *eventHistory_ID_FILTER_NOT_FOUND;
