...
#include "F-Prime/Svc/BufferRepeater/BufferRepeaterComponentAc.hpp"
    ...
    )
  {
    ...
    if (this->m_LogText_OutputPort[0].isConnected()) {
      ...
      const char* _formatString =
        "(%s) %s: Failed to allocate %" PRIi32 " byte buffer for port %" PRIu32 "";
#else
      const char* _formatString =
        "%s: Failed to allocate %" PRIi32 " byte buffer for port %" PRIu32 "";
#endif
