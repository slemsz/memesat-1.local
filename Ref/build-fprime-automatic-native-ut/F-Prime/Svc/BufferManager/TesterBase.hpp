...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //!
      virtual ~BufferManagerTesterBase();
    ...
    public:
      ...
      //!
      NATIVE_INT_TYPE getNum_to_bufferGetCallee() const;
    ...
    protected:
      ...
      //! Handle event NoBuffsAvailable
      //!
      virtual void logIn_WARNING_HI_NoBuffsAvailable(
          U32 size /*!< The requested size*/
      );

      //! A history entry for event NoBuffsAvailable
      //!
      typedef struct {
        U32 size;
      } EventEntry_NoBuffsAvailable;

      //! The history of NoBuffsAvailable events
      //!
      History<EventEntry_NoBuffsAvailable>
        *eventHistory_NoBuffsAvailable;
    ...
    protected:
      ...
      //! Handle event ZeroSizeBuffer
      //!
      virtual void logIn_WARNING_HI_ZeroSizeBuffer(

      );

      //! Size of history for event ZeroSizeBuffer
      //!
      U32 eventsSize_ZeroSizeBuffer;
    ...
    protected:
      ...
      //! Handle channel TotalBuffs
      //!
      virtual void tlmInput_TotalBuffs(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel TotalBuffs
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of TotalBuffs values
      //!
      History<TlmEntry_TotalBuffs>
        *tlmHistory_TotalBuffs;
    ...
    protected:
      ...
      //! Handle channel CurrBuffs
      //!
      virtual void tlmInput_CurrBuffs(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel CurrBuffs
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of CurrBuffs values
      //!
      History<TlmEntry_CurrBuffs>
        *tlmHistory_CurrBuffs;
    ...
    protected:
      ...
      //! Handle channel HiBuffs
      //!
      virtual void tlmInput_HiBuffs(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel HiBuffs
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of HiBuffs values
      //!
      History<TlmEntry_HiBuffs>
        *tlmHistory_HiBuffs;
    ...
    protected:
      ...
      //! Handle channel NoBuffs
      //!
      virtual void tlmInput_NoBuffs(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel NoBuffs
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of NoBuffs values
      //!
      History<TlmEntry_NoBuffs>
        *tlmHistory_NoBuffs;
    ...
    protected:
      ...
      //! Handle channel EmptyBuffs
      //!
      virtual void tlmInput_EmptyBuffs(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel EmptyBuffs
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of EmptyBuffs values
      //!
      History<TlmEntry_EmptyBuffs>
        *tlmHistory_EmptyBuffs;
