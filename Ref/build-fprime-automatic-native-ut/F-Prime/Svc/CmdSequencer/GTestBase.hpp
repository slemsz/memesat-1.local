...
#define ASSERT_EVENTS_CS_JoinWaiting_SIZE(size) \
  this->assertEvents_CS_JoinWaiting_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_CS_JoinWaiting(index, _filename, _recordNumber, _opCode) \
  this->assertEvents_CS_JoinWaiting(__FILE__, __LINE__, index, _filename, _recordNumber, _opCode)

#define ASSERT_EVENTS_CS_JoinWaitingNotComplete_SIZE(size) \
  this->assertEvents_CS_JoinWaitingNotComplete_size(__FILE__, __LINE__, size)
    ...
    public CmdSequencerTesterBase
  {
    ...
    protected:
      ...
      void assertEvents_CS_FileInvalid(
          ...
          const U32 __index, /*!< The index*/
          const char *const fileName, /*!< The name of the sequence file*/
          const Svc::CmdSequencer_FileReadStage stage, /*!< The read stage*/
    ...
    protected:
      ...
      void assertEvents_CS_ModeSwitched(
          ...
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 __index, /*!< The index*/
          const Svc::CmdSequencer_SeqMode mode /*!< The new mode*/
      ) const;
    ...
    protected:
      ...
      void assertEvents_CS_JoinWaiting_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertEvents_CS_JoinWaiting(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 __index, /*!< The index*/
          const char *const filename, /*!< The sequence file*/
    ...
    protected:
      ...
      void assertEvents_CS_JoinWaitingNotComplete_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;
