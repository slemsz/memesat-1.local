...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //!
      NATIVE_INT_TYPE getNum_to_PingReturn() const;

      //! Get the number of from_PingSend ports
      //!
      //! \return The number of from_PingSend ports
      //!
      NATIVE_INT_TYPE getNum_from_PingSend() const;
      ...
      //!
      NATIVE_INT_TYPE getNum_from_WdogStroke() const;
    ...
    private:
      ...
      //!
      Svc::OutputPingPort m_to_PingReturn[25];
    ...
    private:
      ...
      //!
      Svc::InputPingPort m_from_PingSend[25];
