...
namespace Svc {
    ...
    public Fw::ActiveComponentBase
  {
    ...
    PRIVATE:
      ...
      NATIVE_UINT_TYPE m_FileWriteErrorThrottle;

      //! Throttle for InvalidReceiveMode
      NATIVE_UINT_TYPE m_InvalidReceiveModeThrottle;

      //! Throttle for PacketOutOfBounds
      NATIVE_UINT_TYPE m_PacketOutOfBoundsThrottle;

      //! Throttle for PacketOutOfOrder
      NATIVE_UINT_TYPE m_PacketOutOfOrderThrottle;
