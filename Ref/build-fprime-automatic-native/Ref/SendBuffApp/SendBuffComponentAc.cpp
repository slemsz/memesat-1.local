...
namespace Ref {
    ...
    )
  {
    ...
    for (
      PlatformIntType port = 0;
      port < static_cast<PlatformIntType>(this->getNum_ParamGet_OutputPorts());
      port++
    ) {
      ...
      (void) snprintf(
        portName,
        sizeof(portName),
        "%s_ParamGet_OutputPort[%" PRI_PlatformIntType "]",
        this->m_objName,
        port
      );
    ...
    for (
      PlatformIntType port = 0;
      port < static_cast<PlatformIntType>(this->getNum_ParamSet_OutputPorts());
      port++
    ) {
      ...
      (void) snprintf(
        portName,
        sizeof(portName),
        "%s_ParamSet_OutputPort[%" PRI_PlatformIntType "]",
        this->m_objName,
        port
      );
    ...
    for (
      PlatformIntType port = 0;
      port < static_cast<PlatformIntType>(this->getNum_Data_OutputPorts());
      port++
    ) {
      ...
      (void) snprintf(
        portName,
        sizeof(portName),
        "%s_Data_OutputPort[%" PRI_PlatformIntType "]",
        this->m_objName,
        port
      );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<NATIVE_INT_TYPE>(CMD_SB_START_PKTS));
    FW_ASSERT (
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<NATIVE_INT_TYPE>(CMD_SB_INJECT_PKT_ERROR));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<NATIVE_INT_TYPE>(CMD_SB_GEN_FATAL));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<NATIVE_INT_TYPE>(CMD_SB_GEN_ASSERT));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
  ...
  void SendBuffComponentBase ::
    log_ACTIVITY_HI_FirstPacketSent(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void SendBuffComponentBase ::
    log_WARNING_HI_PacketErrorInserted(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void SendBuffComponentBase ::
    log_ACTIVITY_LO_BuffSendParameterUpdated(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
    ...
    paramSave_parameter3()
  {
    if (this->m_ParamSet_OutputPort[0].isConnected()) {
      ...
      Fw::SerializeStatus stat = saveBuff.serialize(m_parameter3);
    ...
    paramSave_parameter4()
  {
    if (this->m_ParamSet_OutputPort[0].isConnected()) {
      ...
      Fw::SerializeStatus stat = saveBuff.serialize(m_parameter4);
