...
#define ASSERT_EVENTS_OpCodeReregistered_SIZE(size) \
  this->assertEvents_OpCodeReregistered_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_OpCodeReregistered(index, _Opcode, _port) \
  this->assertEvents_OpCodeReregistered(__FILE__, __LINE__, index, _Opcode, _port)
    ...
    public CommandDispatcherTesterBase
  {
    ...
    protected:
      ...
      void assertEvents_OpCodeError(
          ...
          const Fw::CmdResponse error /*!< The error value*/
      ) const;
    ...
    protected:
      ...
      void assertEvents_MalformedCommand(
          ...
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 __index, /*!< The index*/
          const Fw::DeserialStatus Status /*!< The deserialization error*/
      ) const;
    ...
    protected:
      ...
      void assertEvents_OpCodeReregistered_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertEvents_OpCodeReregistered(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 __index, /*!< The index*/
          const U32 Opcode, /*!< The opcode reregistered*/
          const I32 port /*!< The reregistration port*/
      ) const;
