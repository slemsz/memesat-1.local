...
namespace Ref {
    ...
    init(NATIVE_INT_TYPE instance)
  {
    ...
    for (
      PlatformIntType port = 0;
      port < static_cast<PlatformIntType>(this->getNum_Data_InputPorts());
      port++
    ) {
      ...
      (void) snprintf(
        portName,
        sizeof(portName),
        "%s_Data_InputPort[%" PRI_PlatformIntType "]",
        this->m_objName,
        port
      );
  ...
  {
    FW_ASSERT(
      portNum < this->getNum_Data_InputPorts(),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  void RecvBuffComponentBase ::
    log_ACTIVITY_LO_FirstPacketReceived(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void RecvBuffComponentBase ::
    log_WARNING_HI_PacketChecksumError(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void RecvBuffComponentBase ::
    log_ACTIVITY_LO_BuffRecvParameterUpdated(U32 id)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
    ...
    paramSave_parameter1()
  {
    if (this->m_ParamSet_OutputPort[0].isConnected()) {
      ...
      Fw::SerializeStatus stat = saveBuff.serialize(m_parameter1);
    ...
    paramSave_parameter2()
  {
    if (this->m_ParamSet_OutputPort[0].isConnected()) {
      ...
      Fw::SerializeStatus stat = saveBuff.serialize(m_parameter2);
