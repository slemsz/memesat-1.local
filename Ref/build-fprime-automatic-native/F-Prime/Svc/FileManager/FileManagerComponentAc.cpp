...
namespace Svc {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_ShellCommandSucceeded(const Fw::LogStringArg& command)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_CreateDirectorySucceeded(const Fw::LogStringArg& dirName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_RemoveDirectorySucceeded(const Fw::LogStringArg& dirName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_RemoveFileSucceeded(const Fw::LogStringArg& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_ShellCommandStarted(const Fw::LogStringArg& command)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_CreateDirectoryStarted(const Fw::LogStringArg& dirName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_RemoveDirectoryStarted(const Fw::LogStringArg& dirName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_RemoveFileStarted(const Fw::LogStringArg& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void FileManagerComponentBase ::
    log_ACTIVITY_HI_FileSizeStarted(const Fw::LogStringArg& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
