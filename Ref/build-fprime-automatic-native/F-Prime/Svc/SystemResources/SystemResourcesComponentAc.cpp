...
#include "F-Prime/Svc/SystemResources/SystemResourcesComponentAc.hpp"
...
namespace Svc {
  ...
  void SystemResourcesComponentBase ::
    log_ACTIVITY_LO_FRAMEWORK_VERSION(const Fw::LogStringArg& version)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void SystemResourcesComponentBase ::
    log_ACTIVITY_LO_PROJECT_VERSION(const Fw::LogStringArg& version)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
